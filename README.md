...
- 셀러(강사/센터)는 수업 등록부터 스케줄 관리, 매출 정산까지 한 곳에서 처리 가능
- 관리자는 수업 승인/반려, 회원·예약 관리, 포인트·쿠폰 수동 지급, 회원 메모 등 플랫폼 운영 전반을 관리
...
<img alt="Server 아키텍처" src="./docs/Server.png" width="100%"/>

### Infra

<img alt="Infra 아키텍처" src="./docs/production.png" width="100%"/>
...
| :---: | :---: |
| - | - |
| 프로젝트 초기 설정·Prisma 스키마<br>센터·클래스·예약·리뷰·포인트·쿠폰·회원 API<br>토스페이먼츠 결제 승인·정산<br>CI/CD 및 BE 배포 등 그 외 전반 | 인증·JWT·Cookie 기반 세션<br>회원가입/로그인/프로필 API<br>알림(Notification)·SSE API |
